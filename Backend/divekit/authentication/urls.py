...
from .views import ObtainTokenPairWithColorView, UserDetailView,UserCreate,UserListView,UserListViewMinified,UserBadgeListView,UserActivationView,CustomTokenRefreshView
